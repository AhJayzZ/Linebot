...
function drawcard(event) {
    ...
    var myoption = {
        ...
        headers: {
            ...
            'Accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/png,image/jpeg,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
